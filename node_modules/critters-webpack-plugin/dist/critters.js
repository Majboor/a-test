...
Critters.prototype.process = function process (compiler, compilation, html) {
    return new Promise((function ($return, $error) {
        ...
        if (this.options.external !== false) {
            ...
            return Promise.all(externalSheets.map(function (link) { return this$1.embedLinkedStylesheet(link, compilation, outputPath); })).then((function ($await_7) {
                try {
...
Critters.prototype.embedLinkedStylesheet = function embedLinkedStylesheet (link, compilation, outputPath) {
    return new Promise((function ($return, $error) {
        var href, media, document, preloadMode, filename, relativePath, asset, lazy, style, script, js, bodyLink, noscript, noscriptLink;
        var sheet, cssLoaderPreamble, noscriptFallback;
